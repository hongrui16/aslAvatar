...
class ASLLVDSkeletonDataset(Dataset):
    ...
    def __init__(self, mode='train', cfg=None):
        ...
        self.min_seq_len = getattr(cfg, 'MIN_SEQ_LEN', 6)
    ...
    def __getitem__(self, idx, debug=False):
        ...
        if self.interpolate and pose_tensor.shape[0] < self.min_seq_len:
            pose_tensor = self._interpolate_sequence(pose_tensor, self.min_seq_len)
